...
CREATE TABLE rm_engagement_frequencies (
    ...
    frequency_name                         VARCHAR2(30), 
    rm_engagement_type_engagement_type_id  INTEGER NOT NULL
);
...
CREATE TABLE rm_engagement_type (
    ...
    engagement_type_name      VARCHAR2(30),
    rm_customers_customer_id  INTEGER NOT NULL
);
...
CREATE TABLE rm_fund_targets (
    ...
    target_description  VARCHAR2(30)
);
...
ALTER TABLE rm_answers
    ADD CONSTRAINT rm_ans_rm_cust_ans_fk FOREIGN KEY ( rm_custmer_answer_customer_answer_id )
        REFERENCES rm_customer_answers ( customer_answer_id );


ALTER TABLE rm_asset_classes
    ADD CONSTRAINT rm_ass_cls_rm_fd_ass_fk FOREIGN KEY ( rm_fund_assets_fund_asset_id )
        REFERENCES rm_fund_assets ( fund_asset_id );

ALTER TABLE rm_asset_objective
    ADD CONSTRAINT rm_ass_obj_rm_cust_ass_fk FOREIGN KEY ( rm_customer_assets_customer_asset_id )
        REFERENCES rm_customer_assets ( customer_asset_id );


ALTER TABLE rm_asset_objective
    ADD CONSTRAINT rm_ass_obj_rm_pot_fd_fk FOREIGN KEY ( rm_potential_funds_fund_id )
        REFERENCES rm_potential_funds ( fund_id );


ALTER TABLE rm_customer_assets
    ADD CONSTRAINT rm_cust_ass_rm_cust_fk FOREIGN KEY ( rm_customers_customer_id )
        REFERENCES rm_customers ( customer_id );

ALTER TABLE rm_customers
    ADD CONSTRAINT rm_cust_rm_cust_ans_fk FOREIGN KEY ( customer_answer_id )
        REFERENCES rm_customer_answers ( customer_answer_id );

ALTER TABLE rm_engagement_frequencies
    ADD CONSTRAINT rm_eng_frq_rm_eng_type_fk FOREIGN KEY ( rm_engagement_type_engagement_type_id )
        REFERENCES rm_engagement_type ( engagement_type_id );

ALTER TABLE rm_engagement_type
    ADD CONSTRAINT rm_eng_type_rm_cust_fk FOREIGN KEY ( rm_customers_customer_id )
        REFERENCES rm_customers ( customer_id );
 
ALTER TABLE rm_fee_structures
    ADD CONSTRAINT rm_fee_strc_rm_ass_cls_fk FOREIGN KEY ( rm_asset_classes_asset_class_id )
        REFERENCES rm_asset_classes ( asset_class_id );

ALTER TABLE rm_potential_funds
    ADD CONSTRAINT rm_pot_fd_rm_fd_ass_fk FOREIGN KEY ( rm_fund_assets_fund_asset_id )
        REFERENCES rm_fund_assets ( fund_asset_id );

ALTER TABLE rm_potential_funds
    ADD CONSTRAINT rm_pot_fd_rm_fd_tgt_fk FOREIGN KEY ( rm_fund_targets_target_id )
        REFERENCES rm_fund_targets ( target_id );

ALTER TABLE rm_questions
    ADD CONSTRAINT rm_ques_rm_ans_fk FOREIGN KEY ( rm_answers_answer_id )
        REFERENCES rm_answers ( answer_id );

ALTER TABLE rm_questions
    ADD CONSTRAINT rm_ques_rm_cust_ans_fk FOREIGN KEY ( rm_customer_answers_customer_answer_id )
        REFERENCES rm_customer_answers ( customer_answer_id );
