...
CREATE TABLE rm_potential_funds (
    ...
    fund_description              VARCHAR2(1000),
...
ALTER TABLE rm_answers
    ADD CONSTRAINT rm_answers_rm_customer_answers_fk FOREIGN KEY ( rm_customer_answers_customer_answer_id )
...
-- Error - Foreign Key RM_Customers_RM_Customer_Answers_FK has no columns
